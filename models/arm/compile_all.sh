python3 compile.py --symbol-file=models/imagenet-inception-bn-quantized.json --param-file=models/imagenet-inception-bn-quantized.params --image-shape=3,224,224 --ctx=cpu
...
python3 compile.py --symbol-file=models/mobilenetv1-quantized.json --param-file=models/mobilenetv1-quantized.params --image-shape=3,224,224 --ctx=cpu
python3 compile.py --symbol-file=models/mobilenetv2-quantized.json --param-file=models/mobilenetv2-quantized.params --image-shape=3,224,224 --ctx=cpu
...
python3 compile.py --symbol-file=models/resnet-152-quantized.json --param-file=models/resnet-152-quantized.params --image-shape=3,224,224 --ctx=cpu
